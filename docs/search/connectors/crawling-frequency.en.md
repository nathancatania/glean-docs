...
### Figma
* Full crawls only ingest and show results to users that have explicitly authorized their Figma accounts with Glean.
...
### Stackoverflow
* Default full crawl is every 28 days.
* Incremental crawl is every 3 hour.
* Identity crawl every hour.
...
| People Data API             | 1 hour                 |                        | Data can be uploaded or modified any time using the push API. Changes will be reflected in the product at a 1 hour cadence.                                                                                                                                                                          |
...
## Deletion of Content
The above discussion applies to deletion of content in the source applications as well since the APIs/webhooks convey deleted content in most major applications. Some applications don't have this information and in these cases the stale content is deleted every time a full crawl is performed.
